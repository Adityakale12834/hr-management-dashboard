...
const Inbox = () => {
  ...
  const sampleReplies = [
    {
      ...
      content:
        "Thanks for the reminder. I have completed my self-assessment and booked a slot with my manager for March 20th at 11 AM.",
      date: "2025-03-18",
      time: "10:30 AM",
    },
    {
      ...
      email: "employee@itcompany.com",
      content:
        "I have reviewed the new WFH policy and submitted my acknowledgment. Looking forward to the hybrid work model!",
      date: "2025-03-14",
      time: "02:45 PM",
    },
  ];
  ...
  const deleteMessage = (messageId) => {
    ...
    setForwardedMessages(
      forwardedMessages.filter((msg) => msg.id !== messageId)
    );
    if (selectedMessage && selectedMessage.id === messageId) {
  ...
  const filteredMessages =
    activeTab === "starred"
      ? [...messages, ...sentMessages, ...forwardedMessages].filter(
          (msg) => msg.starred
        )
      : activeTab === "unread"
            ...
            {/* {showWelcomeBox && (
              <div className="bg-blue-50 rounded-lg p-4 mb-6 shadow-sm relative border-l-4 border-blue-500">
                ...
                <div className="flex items-start">
                  <FiInbox
                    className="text-slate-700 mt-1 mr-3 flex-shrink-0"
                    size={24}
                  />
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      You have {messages.filter((m) => !m.read).length} unread
                      messages. Stay organized with our email management tools.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex border-b mb-4 overflow-x-auto">
              <button
                className={`py-2 px-4 font-medium flex items-center ${
                  activeTab === "inbox"
                    ? "text-slate-600 border-b-2 border-slate-600 bg-slate-100"
              ...
              >
                <FiCornerUpRight className="mr-2" /> Forwarded (
          ...
          <div className="flex-1 overflow-hidden px-6 pb-6">
            ...
            >
              ...
              <div
                ...
                style={{ height: "100%" }}
              >
                <div className="p-4 border border-gray-300 inset-shadow-2xs bg-slate-200">
                ...
                >
                  {filteredMessages.length > 0 ? (
                    filteredMessages.map((message) => (
                      <div
                        key={message.id}
                        className={`p-4 hover:bg-slate-100 cursor-pointer border-b border-gray-100 ${
                          !message.read &&
                          activeTab !== "sent" &&
                          activeTab !== "forwarded"
                            ? "bg-slate-"
                          ...
                          selectedMessage?.id === message.id ? "bg-slate-" : ""
                        }`}
                        onClick={() => {
              ...
              {isComposing ? (
                <div className="w-full md:w-3/5 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col h-full">
                  <div className="p-4 border-b bg-slate-200 border border-gray-300 flex justify-between items-center">
                  ...
                  <div className="flex-1 overflow-y-auto p-6">
                    <div className="mb-4 flex items-center border-b border-gray-300">
                      ...
                      <input
                        type="email"
                        name="to"
                        className="w-full p-2 border-0 rounded-lg focus:ring-0 focus:border-0"
                    ...
                    <div className="mb-4 flex items-center border-b border-gray-300">
                      ...
                      <input
                        type="text"
                        name="subject"
                        className="w-full p-2 border-0 border-gray-300 rounded-lg focus:ring-0 focus:border-0 placeholder:text-sm"
                        placeholder="Subject"
                    ...
                    <textarea
                      name="content"
                      className="w-full px-2 border-0 border-gray-300 rounded-lg mb-3 h-32 focus:ring-0 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div className="mt-2 text-sm text-gray-500">
                      {activeTab === "sent" ? (
                        ...
                        <>
                          ...
                          <p className="mt-1">
                            Original From: {selectedMessage.originalFrom}
                          </p>
                        </>
                      ) : (
                        <p className="font-medium text-gray-700">
                ...
                <div className="hidden md:flex w-3/5 bg-white rounded-lg shadow-sm border border-gray-200 items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <button
                      className="mt-4 px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-black hover:scale-105 transition ease-in flex items-center mx-auto shadow-md"
                      onClick={handleCompose}
                    >
