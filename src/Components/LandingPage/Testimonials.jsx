...
function Testimonials() {
  return (
    <section
      id="testimonials"
      class="relative py-5 bg-yellow-50 sm:py-16 lg:py-24 mx-5 my-5 rounded-2xl"
    >
      ...
      <button className="absolute z-30 bg-black px-10 py-3 text-white rounded-md bottom-40 left-1/2 sm:left-5/12 hover:bg-gray-800">
        Read More
      </button>
    </section>
  );
